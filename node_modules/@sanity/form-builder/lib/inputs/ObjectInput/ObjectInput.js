...
class ObjectInput extends _react.default.PureComponent {
  ...
  renderFieldset(fieldset, fieldsetIndex) {
    ...
    var childPresence = presence.length === 0 ? presence : presence.filter(item => fieldNames.includes(item.path[0]));
    var childMarkers = markers.length === 0 ? markers : markers.filter(item => fieldNames.includes(item.path[0]));
