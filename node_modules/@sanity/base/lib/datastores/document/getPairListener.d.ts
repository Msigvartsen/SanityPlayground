...
export declare function getPairListener(client: SanityClient, idPair: IdPair, options?: PairListenerOptions): Observable<InitialSnapshotEvent | MutationEvent | ReconnectEvent>;
//# sourceMappingURL=getPairListener.d.ts.map