...
`;
const DialogCard = (0, import_react.forwardRef)((props, ref) => {
  const {
  ...
  return /* @__PURE__ */ import_react.default.createElement(DialogContainer, {
    ...
    direction: "column"
  }, /* @__PURE__ */ import_react.default.createElement(DialogHeader, null, /* @__PURE__ */ import_react.default.createElement(import_primitives.Flex, null, /* @__PURE__ */ import_react.default.createElement(import_primitives.Box, {
    flex: 1,
    padding: 4
  }, header && /* @__PURE__ */ import_react.default.createElement(import_primitives.Text, {
    id: labelId,
    weight: "semibold"
  }, header)), /* @__PURE__ */ import_react.default.createElement(import_primitives.Box, {
    padding: 2
...
const Dialog = (0, import_react.forwardRef)((props, ref) => {
