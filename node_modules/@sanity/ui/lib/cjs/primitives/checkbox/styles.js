...
__export(exports, {
  checkboxBaseStyles: () => checkboxBaseStyles,
...
function inputElementStyles(props) {
  ...
  return import_styled_components.css`
    ...
    & + span {
      position: relative;
      display: block;
      height: ${(0, import_styles.rem)(input.checkbox.size)};
      width: ${(0, import_styles.rem)(input.checkbox.size)};
      box-sizing: border-box;
      box-shadow: ${(0, import_internal.focusRingBorderStyle)({
    color: color.default.enabled.border,
    width: input.border.width
  })};
      border-radius: ${(0, import_styles.rem)(radius[2])};
      line-height: 1;
