...
const Root = (0, import_styled_components.default)(import_utils.Layer)`
  pointer-events: none;
`;
const Tooltip = (0, import_react.forwardRef)((props, ref) => {
  ...
  const popperNode = /* @__PURE__ */ import_react.default.createElement(Root, __spreadValues(__spreadProps(__spreadValues({
    "data-ui": "Tooltip"
  }, restProps), {
    ref: setRef,
    style: popper.styles.popper
  }), popper.attributes.popper), /* @__PURE__ */ import_react.default.createElement(import_card.Card, {
    radius: 2,
    shadow: 3
